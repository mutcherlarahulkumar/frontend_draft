export default function StudentHeader(){
    return(
        ...
        <div className="">
            <button className="mx-2 bg-transparent hover:bg-[#d89c4c] text-[#b68233] font-semibold hover:text-white py-2 px-4 border border-[#D4B990] hover:border-transparent rounded">Post Startup Ideas</button>
